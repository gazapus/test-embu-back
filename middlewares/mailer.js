...
function confirmationSignUp(id) {
    return `
        ...
        <p>Para accedera tu cuenta y trabajar con el test de Test de Estilos Educativos Parentales confirmé su registro.</p>
        <br/>
...
function confirmationOriginalEmailChange(id, newEmail) {
    return `
        ...
        <p>
            Se ha seleccionado a ${newEmail} como nueva dirección para su cuenta en Test de Estilos Educativos Parentales
            <br/>
...
function confirmationNewEmailChange(id, newEmail) {
    return `
        <h3>Se ha vinculado esta dirección a una cuenta en Test de Estilos Educativos Parentales</h3>
        <p>
            Se ha seleccionado esta cuenta - ${newEmail} - como nueva dirección para una cuenta en Test de Estilos Educativos Parentales.
            <br/>
...
function confirmationSuccessfull(username, email) {
    return `
        <h3>Se ha confirmado su cuenta en la web del Test Test de Estilos Educativos Parentales</h3>
        <ul>
...
let sendRestartPassword = function (req, res, next) {
    let mailOptions = {
        from: `"Test de Estilos Educativos Parentales" <${mailerConfig.remitent}>`,
        to: res.locals.email,
...
let sendEmailChangeToNew = function (req, res) {
    let mailOptions = {
        from: `"Test de Estilos Educativos Parentales" <${mailerConfig.remitent}>`,
        to: req.body.email,
        subject: 'Se ha vinculado esta dirección en Test de Estilos Educativos Parentales',
